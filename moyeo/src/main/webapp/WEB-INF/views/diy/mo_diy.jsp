  ...
  <div class="container">
		<div class="py-10">
			<div class="diy_content">
				...
				<div class="div_con1">
					<p class="p1">배너 이미지가 들어갈 공간입니다</p>
					<p class="div_title">공식패키지</p>
					<div class="div_p">
						<div class="div_pack1 sp">
							<div class="div_pack1_img">
							</div>
							<div class="div_pack1_text af">
								<p class="t1">공식패키지 제목이 들어갈 공간입니다</p>
								<p class="t2">공식패키지 텍스트 공간 공식패키지 텍스트 공간 공식패키지 텍스트 공간 공식패키지 텍스트 공간 공식패키지 텍스트 공간 공식패키지 텍스트 공간 공식패키지 텍스트 공간 공식패키지 텍스트 공간</p>
								<div class="t_left">
									<p class="t1">출발가</p>
				...
				<div class="div_list_sample">
					...
					<div class="dls_right">
						<ul>
							...
							<li class="l2">텍스트가 들어갈 공간입니다 텍스트가 들어갈 공간입니다 텍스트가 들어갈 공간입니다  텍스트가 들어갈 공간입니다. 텍스트가 들어갈 공간입니다 텍스트가 들어갈 공간입니다 텍스트가 들어갈 공간입니다  텍스트가 들어갈 공간입니다</li>
							<li class="l3">김*아 &nbsp&nbsp&nbsp 2023-08-17</li>
						</ul>
					</div><!-- /dls_right -->
				</div><!-- /div_list_sample -->

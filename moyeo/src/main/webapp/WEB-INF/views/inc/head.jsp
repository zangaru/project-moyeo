 <%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <link href='${pageContext.request.contextPath}/assets/plugins/dzsparallaxer/dzsparallaxer.css' rel='stylesheet'>

	<!-- 패키지상품 슬라이드-->
	<link href='${pageContext.request.contextPath}/assets/plugins/ria/css/swiper.min.css' rel='stylesheet'>
	
	<!-- 베이스css-->
	<link href='${pageContext.request.contextPath}/assets/plugins/ria/css/base.css' rel='stylesheet'>
	
	
	
	<link href='${pageContext.request.contextPath}/assets/plugins/revolution/css/settings.css' rel='stylesheet'>

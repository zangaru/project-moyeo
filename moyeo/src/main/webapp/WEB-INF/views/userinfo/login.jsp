         ...
         <div class="py-10">
            <form id="login_form" method="post" action="<c:url value="/user/login"/>">
               ...
               <div class="login_wrap">
                  ...
                  <div class="login_con">
                     <a href="${pageContext.request.contextPath}/user/findId">아이디
                        찾기</a> <a href="${pageContext.request.contextPath}/user/findPw">비밀번호
                        찾기</a> <a href="${pageContext.request.contextPath}/user/join">회원가입</a>
                  </div>
                  ...
                  <div class="login_button_wrap">
                     ...
                     <p class="btn_k"><img alt="카카오로그인" src="${pageContext.request.contextPath}/assets/img/kakaoBtn.png"
                             onclick="location.href='<c:url value="/kakao/login"/>';">
                       </p>      
                       
                       <p class="btn_n"><img alt="네이버로그인" src="<c:url value="/assets/img/naverBtn.png"/>" width="200"
